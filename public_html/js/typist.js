...
(function() {
	...
	t = function() {
		...
		function i(t, i) {
			null == i && (i = {}), this.typeLetter = e(this.typeLetter, this), this.typeText = e(this.typeText, this), this.selectOffset = e(this.selectOffset,
				this), this.selectText = e(this.selectText, this), this.fetchVariations = e(this.fetchVariations, this), this.next = e(this.next,
				this), this.start = e(this.start, this), this.setupDefaults = e(this.setupDefaults, this), this.options = {
				typist: t,
		...
		return s(i, t), i.prototype.setupDefaults = function() {
			...
			return this.currentVariation = this.variations[this.offsets.current.index], this.offsets.current.text = this.currentVariation.split(
				""), this.selectText()
		}, i.prototype.next = function() {
			return this.offsets.current.index++, this.offsets.current.index = this.offsets.current.index % this.variations.length, this.currentVariation =
				this.variations[this.offsets.current.index], this.offsets.current.text = this.currentVariation.split("")
		}, i.prototype.fetchVariations = function(t) {
			var e, i, s, n, r, o, h;
			for (i = t.getAttribute("data-typist"), i = i.replace(/\\'/g, "'"), i = i.replace(/\\,/g, "!COMMA!"), r = i.split(","), e = o = 0, h =
				r.length; h > o; e = ++o) s = r[e], r[e] = s.replace(/!COMMA!/g, ",");
			for (n = this._getHtml(t), r.splice(0, 0, n), e = 0; e < r.length;) "" === r[e] ? r.splice(e, 1) : e++;
			return r
		}, i.prototype.selectText = function(t) {
			var e;
			return null == t && (t = 0), e = this.offsets.current.text.length - t - 1, e >= 0 && this.selectOffset(e), e > 0 ? this._delay(
				function(e) {
					return function() {
			...
			var e, i, s;
			return i = this.offsets.current.text, e = i.slice(t, i.length).join(""), s = i.slice(0, t).join(""), this._setHtml(this.elements.typist,
				"" + s + '<em class="' + this.options.selectClassName + '">' + e + "</em>")
			...
			var e;
			return null == t && (t = 0), e = this.typeTextSplit[t], 0 === t && (this.elements.typist.innerHTML = ""), this.elements.typist.innerHTML +=
				e, t + 1 >= this.typeTextSplit.length ? this._delay(function(t) {
					return function() {
						return t.selectText()
					}
